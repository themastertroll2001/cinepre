...
namespace cine1.Data
{
    public class Email
    {
        ...
        void Correo(string correo_receptor, string token)
        {
            ...
            email.Subject = "CinePre Validación de Cuenta";
            email.Body = "Para activar su cuenta, haga clic en el siguiente enlace: https://localhost:44361/Cuenta/Token?valor=" + token;
